...
<div class="fomr-group">
 ...
 <div class="form-group">
  ...
  <input type="number" class="form-control" name="aadhar"  placeholder="Enter Aadhar account Number" maxlength="12" required> 
  </div>
  <div class="form-group">
...
<div class="col-md-6">
  ...
  <div class="form-group">
    ...
    <div class="fomr-group">
    <label for="ifsc" class="mt-3 mb-3"> IFSC Number :</label>
   <input type="text" class="form-control" name="ifsc" placeholder="Enter IFSC Number" maxlength="17" required> 
    </div>
    <div class="form-group">
  ...
  <input type="text" class="form-control" name="panid" placeholder="Enter PAN ID number" maxlength="25" > 
  </div>
  <div class="form-group">
